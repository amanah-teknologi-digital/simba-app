$(document).ready(function () {
    $("#datatable").DataTable({
        ...
        columns: [
            ...
            { data: 'nama', name: 'nama', className: 'all', searchable: true },
            { data: 'email', name: 'email', className: 'all', searchable: true },
            { data: 'nohp', name: 'nohp', className: 'all text-center', searchable: true },
            { data: 'created', name: 'created', className: 'all text-center', searchable: false },
